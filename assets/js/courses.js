  ...
  wrapper.innerHTML = (list || []).map(c => `
    <div class="swiper-slide">
      ...
      ${c.description || ""}
        ...
        <button class="apply-btn hidden w-full mt-2 px-4 py-2" data-course="${c.title}" data-dept="${c.department}">
          Apply Now
        </button>
